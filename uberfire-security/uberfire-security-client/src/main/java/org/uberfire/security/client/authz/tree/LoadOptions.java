...
public interface LoadOptions {
     ...
     *
     * @return A collection of string fragments used to compare the node identifier against.
     * If null or empty then this option is ruled out.
     */
    Collection<String> getResourceIdsIncluded();

    /**
     * The resource identifiers to rule out when loading the children nodes.
     *
     * @return A collection of string fragments used to compare the node identifier against.
     * If null or empty then this option is ruled out.
     */
    Collection<String> getResourceIdsExcluded();
